...
- `zAPI_docs/` API documentation can be found here
- `zAPI_docs\REST-OPEN-ORDERS.json` is an open orders REST shape example
- `zAPI_docs\ws_orders_raw.json` is a WS open orders shape example
